...
# Expected latency (4th field) follows DAB 2.1: 200 ms by default (spec 3.4)
# unless the operation states its own limit. Operations that must complete
# before answering (spec 3.5: launch, launch-with-content, exit, voice send)
# have no explicit limit, so they keep their longer allowances.
CONFORMANCE_TEST_CASE = [
    ...
    ("system/settings/set",'{"language": "en-US"}', dab.system.settings_set, 200, "language", "2.0", False),
    ("system/settings/set",'{"language": true}', dab.system.settings_set, 200, "language bad request2", "2.0", True),
    ("system/settings/set",'{"outputResolution": {"width": 3840, "height": 2160, "frequency": 60} }', dab.system.settings_set, 200, "outputResolution", "2.0", False),
    ("system/settings/set",'{"outputResolution": "invalid" }', dab.system.settings_set, 200, "outputResolution bad request", "2.0", True),
    ("system/settings/set",'{"memc": true}', dab.system.settings_set, 200, "memc", "2.0", False),
    ("system/settings/set",'{"memc": "invalid"}', dab.system.settings_set, 200, "memc bad request", "2.0", True),
    ("system/settings/set",'{"cec": true}', dab.system.settings_set, 200, "cec", "2.0", False),
    ("system/settings/set",'{"cec": "invalid"}', dab.system.settings_set, 200, "cec bad request", "2.0", True),
    ("system/settings/set",'{"lowLatencyMode": true}', dab.system.settings_set, 200, "lowLatencyMode", "2.0", False),
    ("system/settings/set",'{"lowLatencyMode": "invalid"}', dab.system.settings_set, 200, "lowLatencyMode Bad Request", "2.0", True),
    ("system/settings/set",'{"matchContentFrameRate": "EnabledSeamlessOnly"}', dab.system.settings_set, 200, "matchContentFrameRate", "2.0", False),
    ("system/settings/set",'{"matchContentFrameRate": "invalid"}', dab.system.settings_set, 200, "matchContentFrameRate Bad Request", "2.0", True),
    ("system/settings/set",'{"hdrOutputMode": "AlwaysHdr"}', dab.system.settings_set, 200, "hdrOutputMode", "2.0", False),
    ("system/settings/set",'{"hdrOutputMode": "invalid"}', dab.system.settings_set, 200, "hdrOutputMode Bad Request", "2.0", True),
    ("system/settings/set",'{"pictureMode": "Standard"}', dab.system.settings_set, 200, "pictureMode", "2.0", False),
    ("system/settings/set",'{"pictureMode": "invalid"}', dab.system.settings_set, 200, "pictureMode Bad Request", "2.0", True),
    ("system/settings/set",'{"audioOutputMode": "Auto"}', dab.system.settings_set, 200, "audioOutputMode", "2.0", False),
    ("system/settings/set",'{"audioOutputMode": "invalid"}', dab.system.settings_set, 200, "audioOutputMode Bad Request", "2.0", True),
    ("system/settings/set",'{"audioOutputSource": "HDMI"}', dab.system.settings_set, 200, "audioOutputSource", "2.0", False),
    ("system/settings/set",'{"audioOutputSource": "invalid"}', dab.system.settings_set, 200, "audioOutputSource Bad Request", "2.0", True),
    ("system/settings/set",'{"videoInputSource": "HDMI1"}', dab.system.settings_set, 200, "videoInputSource", "2.0", False),
    ("system/settings/set",'{"videoInputSource": "invalid"}', dab.system.settings_set, 200, "videoInputSource Bad Request", "2.0", True),
    ("system/settings/set",'{"audioVolume": 10}', dab.system.settings_set, 200, "audioVolume", "2.0", False),
    ("system/settings/set",'{"audioVolume": 120}', dab.system.settings_set, 200, "audioVolume - Negative Test", "2.0", True),
    ("system/settings/set",'{"audioVolume": true}', dab.system.settings_set, 200, "audioVolume bad request", "2.0", True),
    ("system/settings/set",'{"mute": false}', dab.system.settings_set, 200, "mute", "2.0", False),
    ("system/settings/set",'{"mute": "invalid"}', dab.system.settings_set, 200, "mute bad request", "2.0", True),
    ("system/settings/set",'{"textToSpeech": true}', dab.system.settings_set, 200, "textToSpeech", "2.0", False),
    ("system/settings/set",'{"textToSpeech": "invalid"}', dab.system.settings_set, 200, "textToSpeech bad request", "2.0", True),
    ("system/settings/set", '{"screenSaver": true}', dab.system.settings_set, 200, "Set Screen Saver", "2.1", False),
    ("system/settings/set", '{"screenSaverTimeout": 300}', dab.system.settings_set, 200, "Set Screen Saver Timeout", "2.1", False ),
    ("system/settings/set", '{"screenSaverMinTimeout": 60}', dab.system.settings_set, 200, "Screen Saver Min Timeout is not settable", "2.1", True),
    ("system/settings/set", '{"personalizedAds": true}', dab.system.settings_set, 200, "Set Personalized Ads", "2.1" , False),
    ("system/settings/set", '{"highContrastText": true}', dab.system.settings_set, 200, "Set High Contrast Text", "2.1" , False),
    ("system/settings/set", '{"identifierForAdvertising": "38400000-8cf0-11bd-b23e-10b96e40000d"}', dab.system.settings_set, 200, "Set identifier For Advertising", "2.1" , False),
    ("system/settings/set", '{"brightness": 10}', dab.system.settings_set, 200, "Set brightness", "2.1" , False),
    ("system/settings/set", '{"contrast": 10}', dab.system.settings_set, 200, "Set contrast", "2.1" , False),
    ("system/settings/set", '{"timeZone": "America/Los_Angeles"}', dab.system.settings_set, 200, "Set timeZone", "2.1" , False),
    ("input/key/list",'{}', dab.input.list, 200, "Conformance", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_HOME"}', dab.input.key_press, 200, "KEY_HOME", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_VOLUME_UP"}', dab.input.key_press, 200, "KEY_VOLUME_UP", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_VOLUME_DOWN"}', dab.input.key_press, 200, "KEY_VOLUME_DOWN", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_MUTE"}', dab.input.key_press, 200, "KEY_MUTE", "2.0", False),
    ("input/key-press",'{"keyCode": "dummy"}', dab.input.key_press, 200, "dummy", "2.0", True),
    ("input/key-press",'{"keyCode": ""}', dab.input.key_press, 200, "null", "2.0", True),
    ("input/key-press",'{"keyCode": "KEY_CHANNEL_UP"}', dab.input.key_press, 200, "KEY_CHANNEL_UP", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_CHANNEL_DOWN"}', dab.input.key_press, 200, "KEY_CHANNEL_DOWN", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_MENU"}', dab.input.key_press, 200, "KEY_MENU", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_EXIT"}', dab.input.key_press, 200, "KEY_EXIT", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_INFO"}', dab.input.key_press, 200, "KEY_INFO", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_GUIDE"}', dab.input.key_press, 200, "KEY_GUIDE", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_CAPTIONS"}', dab.input.key_press, 200, "KEY_CAPTIONS", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_UP"}', dab.input.key_press, 200, "KEY_UP", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_PAGE_UP"}', dab.input.key_press, 200, "KEY_PAGE_UP", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_PAGE_DOWN"}', dab.input.key_press, 200, "KEY_PAGE_DOWN", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_RIGHT"}', dab.input.key_press, 200, "KEY_RIGHT", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_DOWN"}', dab.input.key_press, 200, "KEY_DOWN", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_LEFT"}', dab.input.key_press, 200, "KEY_LEFT", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_ENTER"}', dab.input.key_press, 200, "KEY_ENTER", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_BACK"}', dab.input.key_press, 200, "KEY_BACK", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_PLAY"}', dab.input.key_press, 200, "KEY_PLAY", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_PLAY_PAUSE"}', dab.input.key_press, 200, "KEY_PLAY_PAUSE", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_PAUSE"}', dab.input.key_press, 200, "KEY_PAUSE", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_STOP"}', dab.input.key_press, 200, "KEY_STOP", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_REWIND"}', dab.input.key_press, 200, "KEY_REWIND", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_FAST_FORWARD"}', dab.input.key_press, 200, "KEY_FAST_FORWARD", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_SKIP_REWIND"}', dab.input.key_press, 200, "KEY_SKIP_REWIND", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_SKIP_FAST_FORWARD"}', dab.input.key_press, 200, "KEY_SKIP_FAST_FORWARD", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_0"}', dab.input.key_press, 200, "KEY_0", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_1"}', dab.input.key_press, 200, "KEY_1", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_2"}', dab.input.key_press, 200, "KEY_2", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_3"}', dab.input.key_press, 200, "KEY_3", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_4"}', dab.input.key_press, 200, "KEY_4", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_5"}', dab.input.key_press, 200, "KEY_5", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_6"}', dab.input.key_press, 200, "KEY_6", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_7"}', dab.input.key_press, 200, "KEY_7", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_8"}', dab.input.key_press, 200, "KEY_8", "2.0", False),
    ("input/key-press",'{"keyCode": "KEY_9"}', dab.input.key_press, 200, "KEY_9", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_RED"}', dab.input.key_press, 200, "KEY_RED", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_GREEN"}', dab.input.key_press, 200, "KEY_GREEN", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_YELLOW"}', dab.input.key_press, 200, "KEY_YELLOW", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_BLUE"}', dab.input.key_press, 200, "KEY_BLUE", "2.0", False),
    ("input/key-press", '{"keyCode": "KEY_YOUTUBE"}', dab.input.key_press, 200, "KEY_YOUTUBE", "2.0", False),
    ("input/key-press",'{"keyCode_": "KEY_HOME"}', dab.input.key_press, 200, "KEY_HOME Bad Request1", "2.0", True),
    ("input/key-press",'{"keyCode": "invalid"}', dab.input.key_press, 200, "KEY_HOME Bad Request2", "2.0", True),
    ("input/key-press",'{"keyCode": true}', dab.input.key_press, 200, "KEY_HOME Bad Request3", "2.0", True),
    ...
    ("health-check/get",'{}', dab.health_check.get, 200, "Conformance", "2.0", False),
    ("voice/list",'{}', dab.voice.list, 200, "Conformance", "2.0", False),
    ("voice/set",f'{{"voiceSystem":{{"name":"{config.va}","enabled":true}}}}', dab.voice.set, 200, "Conformance", "2.0", False),
    ...
    ("applications/install", lambda: json.dumps(ensure_app_available(app_id="Sample_App", prompt_if_missing=False)), dab.applications.install, 60000, "Install App Conformance", "2.1", False),
    ("applications/install", lambda: json.dumps({"appId": "Sample_App", "url": ""}), dab.applications.install, 60000, "Install App Conformance With Blank URL", "2.1", True),
    ("applications/install", lambda: json.dumps(build_incorrect_format_body()), dab.applications.install, 60000, "Install App Conformance With Incorrect Format", "2.1", True),    
    ("applications/uninstall",lambda: f'{{"appId": "{config.apps["sample_app"]}"}}', dab.applications.uninstall, 10000, "Conformance", "2.1", False),
    ("applications/uninstall",lambda: f'{{"appId": "com.example!@#"}}', dab.applications.uninstall, 10000, "Conformance Bad Request", "2.1", True),
    ("applications/clear-data",lambda: f'{{"appId": "{config.apps["youtube"]}"}}', dab.applications.clear_data, 200, "Conformance", "2.1", False),
    ("applications/clear-data",lambda: f'{{"appId": ""}}', dab.applications.clear_data, 200, "Conformance Bad Request", "2.1", True),
    ("applications/install-from-app-store", lambda: json.dumps(build_install_from_app_store_body("Sample_App")), dab.applications.install_from_appstore, 60000, "Install From App Store Conformance", "2.1", False),
    ...
    ("content/open", dab.content.open_body, dab.content.open, 200, "Conformance", "2.1" , False),
