...
CONFORMANCE_TEST_CASE = [
    ...
    ("system/settings/set", '{"highContrastText": false}', dab.system.settings_set, 5000, "Unset High Contrast Text", "2.1" , False),
    ("system/settings/set", '{"highContrastText": "invalid"}', dab.system.settings_set, 5000, "High Contrast Text bad request", "2.1" , True),
