...
CONFORMANCE_TEST_CASE = [
    ...
    ("system/settings/set", '{"screenSaverMinTimeout": 60}', dab.system.settings_set, 200, "Set Screen Saver Min Timeout", "2.1", False),
    ...
    ("applications/install", lambda: json.dumps({"fileLocation": f""}), dab.applications.install, 60000, "Install App Conformance With Blank URL", "2.1", True),
    ...
    ("applications/install-from-app-store", lambda: json.dumps(build_install_from_app_store_body("Sample_App", timeout=60000)), dab.applications.install_from_appstore, 60000, "Install From App Store Conformance", "2.1", False),
